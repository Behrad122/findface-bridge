...
Создает короткое видео с указанной камеры в формате WebM. Видео состоит из 15 кадров снимков с камеры (с задержкой 1 секунда между снимками), сжатых до 1 секунды видео и обернутых в WebM контейнер для batch передачи данных.
...
Получает короткое видео с указанной камеры в формате WebM. Видео состоит из 15 кадров снимков с камеры (с задержкой 1 секунда между снимками), сжатых до 1 секунды видео и обернутых в WebM контейнер для batch передачи данных. Возвращает видеофайл напрямую без JSON обертки.
